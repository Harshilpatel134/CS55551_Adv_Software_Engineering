...
myapp.controller('MongoRestController',function($scope,$http){
    ...
    $scope.insertData = function(){
        ...
        */
        ...
        var req = $http.post('https://murmuring-bayou-68901.herokuapp.com/register',$scope.formData);
    ...
    $scope.searchdata = function(){
      ...
      //  $http.defaults.headers.post['dataType'] = 'json';
        ...
        */
        ...
        var req = $http.post('https://murmuring-bayou-68901.herokuapp.com/search',$scope.formData.search);
        req.success(function(data, status, headers, config) {
            $scope.message = data;
            console.log(data);
        });
