...
public class MainActivity extends Activity {
    ...
    public void weather(View v) {
        ...
        mTextView.setText("knowledge graph:Mohandas Karamchand Gandhi,Indira Gandhi,Assassination of Mahatma Gandhi");
        ...
        try {
            ...
            String hum = t.getString("relative_humidity");
            String win = t.getString("wind_mph");
           String city1=  ((EditText) findViewById(R.id.editext_cityname)).getText().toString();
            ...
            mTextView.setText("Temperature in"+city1+":"+"\n" + dis.toString() + " humidity:"+ hum.toString()+ " wind:" +win.toString());
